"""Alembic environment для async SQLAlchemy 2.x."""
...
# Подменяем sqlalchemy.url на DATABASE_URL из настроек, чтобы alembic.ini
# не содержал реальных секретов и совпадал с FastAPI-приложением.
